...
$('div p a').click(function (evt) {
  $('this').hide()
})

// Write a jQuery statement that adds a button control with an ID of 'SubmitMe' and displays the text 'Login' to a paragraph control that uses a class of 'highlight'.
$('p.highlight').append('button#SubmitMe').text('Login')

// Write a jQuery statement that displays nothing more than a label control containing 'Update Unsuccessful!' within a div with an ID of 'message'. For a bigger challenge, make the text display in red.
$('div#message label').text('Update Unsuccessful').css('color', 'red')

// Write a jQuery statement to set a text box with an ID of 'userid' to the value of 'gwashington'.
$('input:text #userid').val('gwashington')
